...
public class GeodePlusCommonConfigs implements Config {
    ...
    public static final ConfigGroup STONE_ORES_GEODE = new ConfigGroup("Stone Ores Geodes",
            SHOULD_GENERATE_STONE_DIAMOND_GEODE, SHOULD_GENERATE_STONE_EMERALD_GEODE, SHOULD_GENERATE_STONE_LAPIS_GEODE, SHOULD_GENERATE_STONE_REDSTONE_GEODE);

    public static final ConfigGroup DEEPSLATE_ORES_GEODE = new ConfigGroup("Deepslate Ores Geodes",
            SHOULD_GENERATE_DEEPSLATE_DIAMOND_GEODE, SHOULD_GENERATE_DEEPSLATE_EMERALD_GEODE, SHOULD_GENERATE_DEEPSLATE_LAPIS_GEODE, SHOULD_GENERATE_DEEPSLATE_REDSTONE_GEODE);

    public static final ConfigGroup DEEP_DARK_GEODES = new ConfigGroup("Deep Dark Geodes",
            SHOULD_GENERATE_ECHO_GEODE ,SHOULD_GENERATE_SCULK_DIAMOND_GEODE, SHOULD_GENERATE_SCULK_EMERALD_GEODE, SHOULD_GENERATE_SCULK_LAPIS_GEODE, SHOULD_GENERATE_SCULK_REDSTONE_GEODE);
